...
/// @title CasioWatches NFT Contract
/// @notice Contract for minting NFTs with payable mint capability
contract CasioWatches is ERC721, ERC721URIStorage, ERC721Pausable, Ownable, IERC7572 {
    ...
    function tokenURI(
        ...
        // First check if baseURI is empty 
        ...
        uint256 metadataId = tokenId % 8;
        return string.concat(baseURI, metadataId.toString(), baseExtension);
    }

// npx hardhat ignition deploy ./ignition/modules/PaidMint.ts --network localhost
// npx hardhat ignition deploy ./ignition/modules/PaidMint.ts --network sepolia --verify
// npx hardhat ignition deploy ./ignition/modules/PaidMint.ts --network minato --verify
...
const PaidMintModule = buildModule("PaidMintModule", (m) => {
  ...
  const PaidMint = m.contract("PaidMint", [
    name,
    symbol,
    baseURI,
    baseExtension,
